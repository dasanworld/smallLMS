...
export default function LearnerAssignmentListPage({ params }: LearnerAssignmentListPageProps) {
  ...
  const { data, isLoading, error } = useLearnerAssignmentsByCourseQuery(courseId);
